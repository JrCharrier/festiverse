...
festival1 = Festival.new(name: 'We Love Green 2025',
                ...
                image_url: 'app/assets/images/festivals/festival1.png',
...
festival1.image.attach(
  io: File.open(Rails.root.join('app/assets/images/festivals/festival1.png')),
...
festival2 = Festival.new(name: 'Le Jardin du Michel 2025',
                ...
                image_url: 'app/assets/images/festivals/festival2.png',
...
festival2.image.attach(
  io: File.open(Rails.root.join('app/assets/images/festivals/festival2.png')),
...
festival3 = Festival.new(name: 'Festival Marsatac - 27ème Édition',
                ...
                image_url: 'app/assets/images/festivals/festival3.png',
                line_up: "LAYLOW - FONKY FAMILY - BRUTALISMUS 3000 & d'autres artistes à venir"
              )

festival3.image.attach(
  io: File.open(Rails.root.join('app/assets/images/festivals/festival3.png')),
